...
export default function AnimatedProfileHeader({ 
  ...
  const { uploadProfileImage, isUploading: isUploadingAvatar, progress: avatarProgress } = useProfileImage();
  const { uploadProfileBanner, isUploading: isUploadingBanner, progress: bannerProgress } = useProfileBanner();
  ...
  return (
    <>
      <motion.div
        ...
        className="rounded-xl overflow-hidden bg-card border border-border relative"
      >
        {/* Banner */}
        <div className="relative h-36 md:h-56 bg-gradient-to-r from-indigo-500/40 to-purple-600/40 dark:from-indigo-900/40 dark:to-purple-900/40">
          {profile.profile_header_url ? (
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/40 to-purple-600/40 dark:from-indigo-900/40 dark:to-purple-900/40 z-0"></div>
          )}
        ...
        <div className="p-4 md:p-6 pt-16 md:pt-20">
          ...
          <div className="absolute -top-12 md:-top-16 left-4 md:left-6 z-10">
            <div className="relative group">
              ...
              >
                <Avatar 
                  className="h-24 w-24 md:h-32 md:w-32 cursor-pointer hover:opacity-90 transition-opacity"
            ...
            >
              {isCurrentUser ? (
                <Button 
                  ...
                  size="sm" 
                  onClick={onEdit}
                  className="gap-1 hover:bg-muted/80"
                >
