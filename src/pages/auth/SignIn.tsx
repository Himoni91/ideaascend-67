...
import { Eye, EyeOff, Loader2, CircleCheck } from "lucide-react";
...
const SignIn = () => {
  const { signIn, signInWithGoogle, signInWithLinkedIn, isAuthenticated } = useAuth();
  ...
  }, [isAuthenticated, navigate, from, successRedirect]);
        ...
        <AnimatePresence mode="wait">
          {successRedirect ? (
            ...
            >
              ...
              <h2 className="text-xl font-semibold text-green-800 dark:text-green-400">Success!</h2>
